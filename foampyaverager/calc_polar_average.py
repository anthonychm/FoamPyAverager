...
def main(case_path, time, avg_var, origin, ax_col_dir, n_unique_radii):
    ...
    averager = core.PolarAverager(reader, origin, ax_col_dir)
    averager.get_polar_coords()

    # Perform averaging
    averager.get_unique_radii(n_unique_radii)
