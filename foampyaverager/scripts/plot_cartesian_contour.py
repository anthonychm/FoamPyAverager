...
def main(unique_coords_path, avg_var_path, avg_var_col, x_ticks, y_ticks, c_levels, cmap, save_name):
    # Get unique coordinates and averaged variable data
    reader = loader.AveragedReader(unique_coords_path, avg_var_path, avg_var_col)
...
if __name__ == "__main__":
    ...
    main(args_reader.args.unique_coords_path,
         args_reader.args.avg_var_path, args_reader.args.avg_var_col,
